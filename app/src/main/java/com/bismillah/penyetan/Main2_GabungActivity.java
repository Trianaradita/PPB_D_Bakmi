...
public class Main2_GabungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2__gabung);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.beranda:
                        ...
                        startActivity(new Intent(getApplicationContext(), Main_GabungActivity.class));
...
class Tab_adapter2 extends FragmentStatePagerAdapter{
    int jumlahTab;
    public Tab_adapter2(FragmentManager fm, int jumlahTab) {
        super(fm);
